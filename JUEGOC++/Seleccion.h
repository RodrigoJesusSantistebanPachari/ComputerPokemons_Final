...
constexpr int MAX_NUMBER_OF_POKEMON = 20;

constexpr float CalculateHeight1(float height, float number){
	return height/(MAX_NUMBER_OF_POKEMON+6)*number;
}
